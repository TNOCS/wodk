    ...
    export class PropertyTable {
        ...
        private getLZWSet(prop: string) {
            this.wodkSvc.getLZWSets(prop, (set) => {
                ...
                ( < HTMLLinkElement > document.querySelector('#rapport-link')).href = `http://www.zorgopdekaart.nl/bagwoningen/pdfs/rs/RS_${prop}.pdf`;
                ( < HTMLLinkElement > document.querySelector('#rapport-link-descr')).href = `http://www.zorgopdekaart.nl/bagwoningen/pdfs/ra/RA_${prop}.pdf`;
