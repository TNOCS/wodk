/**
 * Concrete row chart implementation with star labels.
 *
 * Examples:
...
(function (global) {
    ...
        var _g;
        ...
        function updateElements(rows) {
            ...
            // var circle = rows.attr('transform', function (d, i) {
            //     return 'translate(0,' + ((i + 1) * _gap + i * height) + ')';
            // }).select('circle')
            //     .attr('height', height)
            //     .attr('cy', height/2)
            ...
            var polygon = rows.attr('transform', function (d, i) {
                return 'translate(0,' + ((i + 1) * _gap + i * height) + ')';
            }).select('polygon')
                .attr('transform', 'scale(' + (Math.min(height, 25)/200) + ') translate(-200 0)')
                .attr('fill', _chart.getColor)
                .on('click', onClick)
                .classed('deselected', function (d) {
                    return (_chart.hasFilter()) ? !isSelectedRow(d) : false;
